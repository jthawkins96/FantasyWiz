...
public class ImportReceiver extends AsyncTask<Void, Void, String> {
    ...
    public ImportReceiver(Context c, String urlAddress, String query, ListView listView, Button Import, TextView...details) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if (s != null){
            if (!s.contains("null")){
                ImportParser p = new ImportParser(c, s, listView, Import);
                p.execute();
